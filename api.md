...
- <code title="get /v2/tenancy/discovery">client.tenancy.<a href="./src/giskard_hub/resources/tenancy.py">discovery</a>() -> dict</code>
- <code title="get /v2/tenancy/health">client.tenancy.<a href="./src/giskard_hub/resources/tenancy.py">health</a>() -> <a href="./src/giskard_hub/types/tenancy.py">HealthStatus</a></code>
- <code title="post /v2/tenancy/find-tenant">client.tenancy.<a href="./src/giskard_hub/resources/tenancy.py">find_tenant</a>(\*\*<a href="src/giskard_hub/types/tenancy.py">params</a>) -> <a href="./src/giskard_hub/types/tenancy.py">FindTenantResponse</a></code>
