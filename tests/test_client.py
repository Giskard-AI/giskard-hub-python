...
from giskard_hub import HubClient, AsyncHubClient, APIResponseValidationError
from giskard_hub._types import Omit
from giskard_hub._utils import asyncify
from giskard_hub._models import BaseModel, FinalRequestOptions
from giskard_hub._exceptions import (
    APIStatusError,
    HubClientError,
    APITimeoutError,
    APIResponseValidationError,
)
from giskard_hub._base_client import (
    DEFAULT_TIMEOUT,
...
class TestHubClient:
    ...
    def test_copy(self, client: HubClient) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: HubClient) -> None:
    ...
    def test_copy_signature(self, client: HubClient) -> None:
    ...
    def test_copy_build_request(self, client: HubClient) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "giskard_hub/_legacy_response.py",
                        "giskard_hub/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "giskard_hub/_compat.py",
    ...
    def test_request_timeout(self, client: HubClient) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_request_extra_json(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: HubClient) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: HubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch(
        "giskard_hub._base_client.BaseClient._calculate_retry_timeout",
        _low_retry_timeout,
    )
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: HubClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncHubClient:
    ...
    def test_copy(self, async_client: AsyncHubClient) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncHubClient) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncHubClient) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    def test_copy_build_request(self, async_client: AsyncHubClient) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    def test_multipart_repeating_array(self, async_client: AsyncHubClient) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    async def test_base_url_trailing_slash(self, client: AsyncHubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncHubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncHubClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
