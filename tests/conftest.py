...
from giskard_hub import HubClient, AsyncHubClient, DefaultAioHttpClient
from giskard_hub._utils import is_dict
...
logging.getLogger("giskard_hub").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[HubClient]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncHubClient]:
