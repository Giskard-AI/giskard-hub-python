...
class TestProbes:
    ...
    def test_raw_response_retrieve(self, client: HubClient) -> None:
        response = client.scans.probes.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: HubClient) -> None:
        with client.scans.probes.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_method_list_attempts(self, client: HubClient) -> None:
        ...
        assert_matches_type(List[ScanProbeAttempt], probe, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list_attempts(self, client: HubClient) -> None:
        response = client.scans.probes.with_raw_response.list_attempts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list_attempts(self, client: HubClient) -> None:
        with client.scans.probes.with_streaming_response.list_attempts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
...
class TestAsyncProbes:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncHubClient) -> None:
        response = await async_client.scans.probes.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncHubClient) -> None:
        async with async_client.scans.probes.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
    ...
    async def test_raw_response_list_attempts(self, async_client: AsyncHubClient) -> None:
        response = await async_client.scans.probes.with_raw_response.list_attempts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_list_attempts(self, async_client: AsyncHubClient) -> None:
        async with async_client.scans.probes.with_streaming_response.list_attempts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
