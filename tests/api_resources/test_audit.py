...
class TestAudit:
    ...
    def test_method_search(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIPaginatedResponse[AuditAPIResource, None], audit, path=["response"])
    ...
    def test_method_list_entities(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIPaginatedResponse[AuditDisplayAPIResource, None], audit, path=["response"])
