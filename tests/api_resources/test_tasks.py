...
class TestTasks:
    ...
    def test_method_create(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponse[Task], task, path=["response"])
    ...
    def test_path_params_retrieve(self, client: HubClient) -> None:
        with pytest.raises(
            ValueError,
            match=r"Expected a non-empty value for `task_id` but received ''",
        ):
    ...
    def test_method_list(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponse[List[Task]], task, path=["response"])
    ...
    def test_method_delete(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponse[None], task, path=["response"])
    ...
    def test_raw_response_bulk_delete(self, client: HubClient) -> None:
        response = client.tasks.with_raw_response.bulk_delete(
            task_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    def test_streaming_response_bulk_delete(self, client: HubClient) -> None:
        with client.tasks.with_streaming_response.bulk_delete(
            task_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
...
class TestAsyncTasks:
    ...
    async def test_method_bulk_delete(self, async_client: AsyncHubClient) -> None:
        task = await async_client.tasks.bulk_delete(
            task_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(APIResponse[None], task, path=["response"])
    ...
    async def test_raw_response_bulk_delete(self, async_client: AsyncHubClient) -> None:
        response = await async_client.tasks.with_raw_response.bulk_delete(
            task_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    async def test_streaming_response_bulk_delete(self, async_client: AsyncHubClient) -> None:
        async with async_client.tasks.with_streaming_response.bulk_delete(
            task_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
