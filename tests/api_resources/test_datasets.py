...
class TestDatasets:
    ...
    def test_method_create(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseDataset, dataset, path=["response"])
    ...
    def test_method_delete(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseNone, dataset, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_generate_adversarial(self, client: HubClient) -> None:
    ...
    def test_method_generate_adversarial_with_all_params(self, client: HubClient) -> None:
        dataset = client.datasets.generate_adversarial(
            ...
            description="description",
            n_examples_per_category=0,
        )
        assert_matches_type(APIResponseDataset, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_generate_adversarial(self, client: HubClient) -> None:
        response = client.datasets.with_raw_response.generate_adversarial(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_generate_adversarial(self, client: HubClient) -> None:
        with client.datasets.with_streaming_response.generate_adversarial(
            agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_method_list_tags(self, client: HubClient) -> None:
        ...
        assert_matches_type(DatasetListTagsResponse, dataset, path=["response"])
    ...
    def test_method_list_test_cases(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseListTestCase, dataset, path=["response"])
...
class TestAsyncDatasets:
    ...
    async def test_method_export(self, async_client: AsyncHubClient) -> None:
        dataset = await async_client.datasets.export(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_raw_response_export(self, async_client: AsyncHubClient) -> None:
        response = await async_client.datasets.with_raw_response.export(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_export(self, async_client: AsyncHubClient) -> None:
        async with async_client.datasets.with_streaming_response.export(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
    ...
    async def test_path_params_export(self, async_client: AsyncHubClient) -> None:
        with pytest.raises(
            ...
            await async_client.datasets.with_raw_response.export(
                "",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_export_selected(self, async_client: AsyncHubClient) -> None:
        dataset = await async_client.datasets.export_selected(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, dataset, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_export_selected_with_all_params(self, async_client: AsyncHubClient) -> None:
        dataset = await async_client.datasets.export_selected(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            test_case_ids=["string", "string", "string"],
        )
        assert_matches_type(object, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_export_selected(self, async_client: AsyncHubClient) -> None:
        response = await async_client.datasets.with_raw_response.export_selected(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_export_selected(self, async_client: AsyncHubClient) -> None:
        async with async_client.datasets.with_streaming_response.export_selected(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_export_selected(self, async_client: AsyncHubClient) -> None:
        with pytest.raises(
            ValueError,
            match=r"Expected a non-empty value for `dataset_id` but received ''",
        ):
            await async_client.datasets.with_raw_response.export_selected(
                "",
            )
