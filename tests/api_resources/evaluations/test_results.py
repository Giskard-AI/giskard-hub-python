...
from giskard_hub.types import TestCase, APIResponse, APIPaginatedResponse, APIResponseWithIncluded
from giskard_hub.types.evaluations import TestCaseEvaluationAPIResource
...
class TestResults:
    ...
    def test_method_retrieve(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseWithIncluded[TestCaseEvaluationAPIResource, TestCase], result, path=["response"])
    ...
    def test_streaming_response_retrieve(self, client: HubClient) -> None:
        with client.evaluations.results.with_streaming_response.retrieve(
            ...
            result = response.parse()
            assert_matches_type(
                APIResponseWithIncluded[TestCaseEvaluationAPIResource, TestCase], result, path=["response"]
            )
    ...
    def test_method_list(self, client: HubClient) -> None:
        ...
        assert_matches_type(
            APIResponseWithIncluded[List[TestCaseEvaluationAPIResource], TestCase], result, path=["response"]
        )
    ...
    def test_streaming_response_search(self, client: HubClient) -> None:
        with client.evaluations.results.with_streaming_response.search(
            ...
            result = response.parse()
            assert_matches_type(
                APIPaginatedResponse[TestCaseEvaluationAPIResource, TestCase], result, path=["response"]
            )
