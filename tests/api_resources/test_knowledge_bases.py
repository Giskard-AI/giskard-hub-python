...
class TestKnowledgeBases:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_search_documents(self, client: HubClient) -> None:
        response = client.knowledge_bases.with_raw_response.search_documents(
            knowledge_base_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_search_documents(self, client: HubClient) -> None:
        with client.knowledge_bases.with_streaming_response.search_documents(
            knowledge_base_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Giskard-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_search_documents(self, client: HubClient) -> None:
        with pytest.raises(
            ValueError,
            match=r"Expected a non-empty value for `knowledge_base_id` but received ''",
        ):
            client.knowledge_bases.with_raw_response.search_documents(
                knowledge_base_id="",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_document(self, client: HubClient) -> None:
        knowledge_base = client.knowledge_bases.retrieve_document(
            knowledge_base_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(APIResponse[KnowledgeBaseDocumentDetailAPIResource], knowledge_base, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_document(self, client: HubClient) -> None:
        response = client.knowledge_bases.with_raw_response.retrieve_document(
            knowledge_base_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_document(self, client: HubClient) -> None:
        with client.knowledge_bases.with_streaming_response.retrieve_document(
            knowledge_base_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_retrieve_document(self, client: HubClient) -> None:
        with pytest.raises(
            ValueError,
            match=r"Expected a non-empty value for `knowledge_base_id` but received ''",
        ):
            client.knowledge_bases.with_raw_response.retrieve_document(
                knowledge_base_id="",
                document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
