...
from giskard_hub.types import APIResponseNone
...
class TestComments:
    ...
    def test_method_delete(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseNone, comment, path=["response"])
    ...
    def test_method_add(self, client: HubClient) -> None:
        ...
        assert_matches_type(APIResponseTestCaseComment, comment, path=["response"])
